...
RisuVault는 RisuBard 0.9.25와 같은 V1 저장 구조를 사용하며, V2 저장 구조는 도입한 적이 없습니다. RisuBard 0.9.26~0.9.27에서 V2로 이관한 세이브는 별도 변환기로 새 V1 폴더를 만든 뒤 RisuVault에서 사용할 수 있습니다.
...
1. 실행 중인 RisuVault와 RisuBard를 모두 종료합니다.
...
RisuVault 소스 폴더에서는 V2 원본 경로 하나만 지정합니다.
...
RisuVault 소스 폴더에서 서버를 종료한 뒤 다음 한 줄을 실행합니다.
