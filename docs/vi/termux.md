...
Hướng dẫn này giải thích cách xây dựng và chạy RisuVault trực tiếp trên điện thoại Android sử dụng Termux. Mẫu sử dụng dự kiến là mở `http://localhost:7777` trong trình duyệt của chính điện thoại.
