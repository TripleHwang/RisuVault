...
This guide explains how to build and run RisuVault directly on an Android phone using Termux. The intended use pattern is to open `http://localhost:7777` in the phone's own browser.
