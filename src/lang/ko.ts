...
export const languageKorean = {
  ...
  saveBackupForUpstreamConfirm:
    "이 백업은 원본 RisuAI(웹·Tauri)로 데이터를 옮기기 위한 용도입니다. 인레이 이미지와 BardWiki·원고 같은 RisuVault 전용 파일은 제외됩니다. 그 외 데이터(데이터베이스, 캐릭터 에셋, 콜드 스토리지)는 포함됩니다.\n\nRisuVault 사이의 데이터 이동에는 일반 전체 백업을 사용하세요.\n\n계속하시겠습니까?",
  ...
  externalEditModeStartConfirm:
    "현재 변경 사항을 저장한 뒤 브라우저 저장을 일시 중지합니다. 외부 편집을 마칠 때까지 RisuVault에서 내용을 편집하거나 생성하지 마세요.\n\n외부 파일 편집을 시작할까요?",
  ...
  builtInPlugins: "내장 플러그인",
  builtInPluginsDescription: "RisuVault에 함께 들어 있는 플러그인입니다. 여기서 켜면 내장 사본이 실행되며, 켜져 있는 동안 직접 설치한 같은 이름의 플러그인은 무시됩니다.",
  builtInPersonaBinder: "페르소나 바인더 (내장)",
  builtInPersonaBinderDescription: "채팅마다 페르소나를 묶어 두고, 선택한 모델 프리셋으로 대화 흐름에 맞춰 자동으로 다듬습니다. 켜져 있는 동안 Temp Persona 항목과 요청 훅이 추가됩니다.",
  ...
  storageDiagnosticsNoDataDesc: "RisuVault를 평소처럼 사용해 저장 표본이 쌓인 뒤 다시 확인하세요.",
  systemLogs: "시스템 로그",
  systemLogsDesc:
  ...
  risuBardGrimoirePrompt: {
    ...
    current: "현재",
    builtin: "보호된 기본값",
    protectedDescription: "이 기본값은 RisuVault가 관리하므로 수정하거나 삭제할 수 없습니다.",
    content: "분석 지시문",
