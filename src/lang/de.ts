...
export const languageGerman = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Dies kann ein CORS-Fehler sein. Dies geschieht nur bei Verwendung der Webversion aufgrund von Browserbeschränkungen. Versuchen Sie, die lokale Desktop-Version oder eine andere Version von RisuVault zu verwenden.",
    ...
    "setup": {
        ...
        "welcome": "Willkommen bei RisuVault! Ich bin Airisu und werde Sie durch die Einrichtung von RisuVault führen. Zuerst, wie darf ich Sie nennen?",
    ...
    "risupresetDesc": "Risupreset-Format ist ein Format, das speziell für RisuVault-Voreinstellungen entwickelt wurde.",
    "risuMDesc": "RisuM-Format ist ein Format, das speziell für RisuVault-Module entwickelt wurde.",
    ...
    "pluginVersionWarn": "Dies ist Version {{plugin_version}} des Plugins, die nicht mit dieser Version von RisuVault kompatibel ist. Bitte aktualisieren Sie das Plugin auf Version {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuVault hat Code erkannt, der schädlich sein könnte und IHREN API-SCHLÜSSEL ODER PERSÖNLICHE DATEN STEHLEN KANN. Wir empfehlen Ihnen, DIESES PLUGIN NICHT ZU INSTALLIEREN.",
    "doNotInstall": "Nicht installieren",
    "continueAnyway": "Trotzdem fortfahren",
    "pluginNoRiskButAlert": "RisuVault hat keinen schädlichen Code erkannt, aber beachten Sie bitte, dass die Installation von Plugins aus nicht vertrauenswürdigen Quellen Sicherheitsrisiken bergen kann.",
