...
export const languageVietnamese = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "This can be a CORS error. this only happens when using web version dude to limitations of the browser. try using desktop local version, or other version of RisuVault.",
    ...
    "setup": {
        ...
        "welcome": "Chào mừng đến với RisuVault! Tôi là Airisu, tôi ở đây để hướng dẫn bạn cài đặt RisuVault. Trước tiên, tôi có thể gọi bạn là gì?",
    ...
    "risupresetDesc": "Định dạng Risupreset là định dạng được thiết kế dành riêng cho các cài đặt trước RisuVault.",
    "risuMDesc": "Định dạng RisuM là định dạng được thiết kế dành riêng cho các mô-đun RisuVault.",
    ...
    "pluginVersionWarn": "Đây là phiên bản {{plugin_version}} của plugin, không tương thích với phiên bản RisuVault này. Vui lòng cập nhật plugin lên phiên bản {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuVault phát hiện mã có thể gây hại, có thể ĂN CẮP KHÓA API HOẶC DỮ LIỆU CÁ NHÂN CỦA BẠN. Chúng tôi khuyên bạn KHÔNG NÊN CÀI ĐẶT PLUGIN NÀY.",
    "doNotInstall": "Không cài đặt",
    "continueAnyway": "Vẫn tiếp tục",
    "pluginNoRiskButAlert": "RisuVault không phát hiện mã độc hại, nhưng xin lưu ý rằng việc cài đặt plugin từ các nguồn không tin cậy có thể gây rủi ro bảo mật.",
