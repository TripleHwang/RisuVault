...
export const languageEnglish = {
    ...
    saveBackupForUpstreamConfirm: "This backup is intended for moving your data to the original RisuAI (web/Tauri). Inlay images and RisuVault-only files such as BardWiki and manuscripts are excluded. Other data (database, character assets, cold storage) is included.\n\nFor moving data between RisuVault installations, use the regular full backup instead.\n\nProceed?",
    ...
    externalEditModeStartConfirm: "RisuVault will save current changes, then pause browser saving. Do not edit or generate content in RisuVault until external editing is finished.\n\nStart external file editing?",
    externalEditModeFinishConfirm: "RisuVault will validate the externally edited files and reload them. Invalid files will keep saving paused so they can be corrected.\n\nFinish external editing and reload?",
    ...
    builtInPluginsDescription: "Plugins RisuVault ships with. Turning one on here runs the bundled copy; a copy you installed yourself is then ignored while this is on.",
    builtInPersonaBinder: "Persona Binder (built-in)",
    builtInPersonaBinderDescription: "Binds a persona to each chat and can rewrite it automatically from the conversation, using a model preset you choose. Adds a Temp Persona entry and a request hook while on.",
    goToChat: "Go to Chat",
    bookmark: "Bookmark",
    translate: "Translate",
    branch: "Branch",
    ...
    storageDiagnosticsNoDataDesc: "Use RisuVault normally and return here after some saves have been observed.",
    ...
    risuBardGrimoirePrompt: {
        ...
        protectedDescription: "This default is maintained by RisuVault and cannot be edited or deleted.",
